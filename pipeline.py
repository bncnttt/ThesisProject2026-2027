...
try:
    ...
    db = mongo_client["AgapAI_Database"]
...
# ⚠️ MAKE SURE THIS IS YOUR 16-CHARACTER APP PASSWORD (e.g., xxxx-xxxx-xxxx-xxxx)
BLUESKY_HANDLE = "centblsky.bsky.social" 
BLUESKY_PASSWORD = "ebjd-ium2-gqew-cib6" 

# Core disaster keyword list
DISASTER_KEYWORDS = [
...
LOCATION_MARKERS = [
    ...
    "benguet", "albay", "cagayan", "pampanga", "bulacan", "cavite", 
...
def get_author_live_feed_posts(actor, max_posts):
    ...
    while len(posts) < max_posts:
        try:
            # Safe Dictionary Params approach
...
def authenticate_session():
    try:
        ...
        # Changed {e} to {repr(e)} to force out the full error message string
